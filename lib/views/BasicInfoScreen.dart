...
//   //     /// ✅ FIX: specialty preselect
//   //     if (d.specialty != null && d.specialty!.isNotEmpty) {
//   //       selectedSpecialties = [d.specialty!];
//   //     }
//   //   }
//   // }
//   @override
...
//   if (d == null) return; // ✅ MOST IMPORTANT
...
//   /// ✅ SAFE specialty mapping
//   if (d.specialty != null && d.specialty!.isNotEmpty) {
//     final firstSpecialty = d.specialty!.first;
//     if (firstSpecialty.id != null) {
//       selectedSpecialties = [firstSpecialty.id!];
//     }
//   }
// }
...
//   /// ✅ FIX: ONLY select image, DO NOT upload here
//   Future<void> _pickImage(ImageSource source) async {
//     final XFile? picked =
//         await ImagePicker().pickImage(source: source, imageQuality: 60);
...
//         final safeSpecialty =
//             selectedSpecialties.isNotEmpty ? selectedSpecialties.first : null;
  ...
  Widget build(BuildContext context) {
    return GestureDetector(
      ...
      child: Obx(() {
        ...
        /// ✅ PRESELECT SPECIALTY SAFELY (LIKE NAME FIELD)
        if (selectedSpecialties.isEmpty &&
            d?.specialty != null &&
            d!.specialty!.isNotEmpty) {
          final id = d.specialty!.first.id;
          if (id != null) {
        ...
        if (selectedImage != null) {
          avatarImage = FileImage(selectedImage!);
        } else if (d?.photo != null && d!.photo!.isNotEmpty) {
          avatarImage = NetworkImage(
