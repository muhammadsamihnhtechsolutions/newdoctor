...
class GetDoctorApiResponse {
  ...
  factory GetDoctorApiResponse.fromMap(Map<String, dynamic> map) {
    return GetDoctorApiResponse(
      ...
      data: map['data'] != null
          ? DoctorProfileData.fromMap(map['data'])
          : null,
    );
  }
...
class DoctorProfileData {
  ...
  DoctorProfileData copyWith({
    ...
    return DoctorProfileData(
      ...
      experienceInYear:
          experienceInYear ?? this.experienceInYear,
      ratingCount: ratingCount ?? this.ratingCount,
      totalPatientCount:
          totalPatientCount ?? this.totalPatientCount,
  ...
  factory DoctorProfileData.fromMap(Map<String, dynamic> map) {
    return DoctorProfileData(
      ...
      averageConsultancyTime:
          map['averageConsultancyTime']?.toString(),
      averageResponseTime:
          map['averageResponseTime']?.toString(),
      consultationFee: map['consultationFee']?.toString(),
      followupFee: map['followupFee']?.toString(),
      experienceInYear:
          map['experienceInYear']?.toString(),
      ratingCount: map['ratingCount']?.toString(),
      totalPatientCount:
          map['totalPatientCount']?.toString(),
...
class DoctorSpecialty {
  String? id; // ✅ ONLY FIX: nullable
  String? title;
  String? symptoms;

  DoctorSpecialty({this.id, this.title, this.symptoms});
