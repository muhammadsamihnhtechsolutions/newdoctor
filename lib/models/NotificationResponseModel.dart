...
class NotificationData {
  ...
  factory NotificationData.fromJson(Map<String, dynamic> json) => NotificationData(
        notificationList:
            json["docs"] == null ? [] : List<NotificationModel>.from(json["docs"]!.map((x) => NotificationModel.fromJson(x))),
  ...
  Map<String, dynamic> toJson() => {
        "docs": notificationList == null ? [] : List<dynamic>.from(notificationList!.map((x) => x.toJson())),
        "totalDocs": totalDocs,
        "limit": limit,
        "page": page,
...
class NotificationMetaData {
  ...
  factory NotificationMetaData.fromJson(Map<String, dynamic> json) => NotificationMetaData(
        ...
        doctor: json["doctor"],
        weight: json["weight"] != null ? double.parse("${json["weight"]}") : 0.0,
        age: json["age"],
        reason: json["reason"],
        ...
        eyePhotos: json["eyePhotos"] == null ? [] : List<String>.from(json["eyePhotos"]!.map((x) => x)),
        additionalFiles: json["additionalFiles"] == null ? [] : List<dynamic>.from(json["additionalFiles"]!.map((x) => x)),
        promoCode: json["promoCode"] != null ? "${json["promoCode"]}" : "",
        totalAmount: json["totalAmount"] != null ? double.parse("${json["totalAmount"]}") : 0.0,
        ...
        grandTotal: json["grandTotal"] != null ? double.parse("${json["grandTotal"]}") : 0.0,
  ...
  Map<String, dynamic> toJson() => {
        ...
        "date": date,
        "eyePhotos": eyePhotos == null ? [] : List<dynamic>.from(eyePhotos!.map((x) => x)),
        "additionalFiles": additionalFiles == null ? [] : List<dynamic>.from(additionalFiles!.map((x) => x)),
        "promoCode": promoCode,
