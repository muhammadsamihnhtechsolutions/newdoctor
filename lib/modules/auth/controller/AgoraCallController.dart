...
//           onUserJoined: (_, uid, __) {
//             remoteUid.value = uid; // 👈 patient Agora UID
//             isRemoteUserJoined.value = true;
//             _patientJoinTimer?.cancel();
//           },
...
//               (connection, speakers, totalVolume, vad) {
//             if (remoteUid.value == 0) return;

//             bool speakingNow = false;

//             for (final s in speakers) {
//               if (s.uid == remoteUid.value) {
//                 final vol = s.volume ?? 0;
//                 final vadFlag = s.vad ?? 0;
